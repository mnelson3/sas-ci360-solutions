...
class Standard:
    ...
    gDirDataResponseFileTransferLocationPost = (
        "/data/response/file_transfer_location_post/"
    )
    ...
    def __init__(self, **kwargs):
        ...
        # FILES
        self._export_file = config_parser.get(
            "FILES", "export_file", fallback="export.csv"
        )
        self._export_file_arr = config_parser.get(
            "FILES", "export_file_arr", fallback=""
        )
        ...
        self._secret_key = config_parser.get(
            "IDENTITIES", "secret_key", fallback="changeme"
        )
        self._secret_key_arr = config_parser.get(
            "IDENTITIES", "secret_key_arr", fallback=""
        )
        self._tenant_id = config_parser.get(
            "IDENTITIES", "tenant_id", fallback="changeme"
        )
        self._tenant_id_arr = config_parser.get(
            "IDENTITIES", "tenant_id_arr", fallback=""
        )

        # PATHS
        self._export_path = config_parser.get(
            "PATHS", "export_path", fallback="/data/export/"
        )
        self._export_path_arr = config_parser.get(
            "PATHS", "export_path_arr", fallback=""
        )
        ...
        self._external_gateway_path = config_parser.get(
            "PATHS",
            "external_gateway_path",
            fallback="extapigwservice-training.ci360.sas.com",
        )
        ...
        self.file_transfer_location_path = config_parser.get(
            "PATHS",
            "file_transfer_location_path",
            fallback="/marketingData/fileTransferLocation",
        )
        self.import_request_jobs_path = config_parser.get(
            "PATHS",
            "import_request_jobs_path",
            fallback="/marketingData/importRequestJobs",
        )
        self.reports_path = config_parser.get(
            "PATHS", "reports_path", fallback="/reports/"
        )
        ...
        self._tenant_name_arr = config_parser.get(
            "SETTINGS", "tenant_name_arr", fallback=""
        )
        self._tenant_number = config_parser.get(
            "SETTINGS", "tenant_number", fallback="000000"
        )
        self._tenant_number_arr = config_parser.get(
            "SETTINGS", "tenant_number_arr", fallback=""
        )
        self._tenant_product = config_parser.get(
            "SETTINGS", "tenant_product", fallback="SAS Customer Intelligence 360"
        )
        self._tenant_product_arr = config_parser.get(
            "SETTINGS", "tenant_product_arr", fallback=""
        )
        ...
        self._tenant_url_arr = config_parser.get(
            "SETTINGS", "tenant_url_arr", fallback=""
        )
    ...
    def email_msg_support_from(self):
        return self._by_mode(
            self._email_msg_support_from_arr, self._email_msg_support_from
        )

    @property
    def email_msg_support_from_arr(self):
        return self._by_mode(
            self._email_msg_support_from_arr, self._email_msg_support_from_arr
        )
    ...
    def email_msg_support_to_arr(self):
        return self._by_mode(
            self._email_msg_support_to_arr, self._email_msg_support_to_arr
        )
    ...
    def email_msg_support_cc_arr(self):
        return self._by_mode(
            self._email_msg_support_cc_arr, self._email_msg_support_cc_arr
        )
    ...
    def external_gateway_path(self):
        return self._by_mode(
            self._external_gateway_path_arr, self._external_gateway_path
        )

    @property
    def external_gateway_path_arr(self):
        return self._by_mode(
            self._external_gateway_path_arr, self._external_gateway_path_arr
        )
