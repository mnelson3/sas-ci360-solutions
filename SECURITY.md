...
This repository holds the actively maintained automation engine and orchestration layer for SAS Customer Intelligence 360 (CI360) operations — a Windows/Linux service automating data processing, campaign execution, and workflow management. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas-ci360-solutions/security/advisories/new) (enabled on this repo), or
